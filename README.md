...
|        | 3x3  | 0.01s        | `[[4 1 6]` <br> `[3 0 5]` <br> `[2 7 8]]`                                                                     | `[[1 2 3]` <br> `[4 5 6]` <br> `[7 8 0]]`                                                                     | RANDOMIZED_STEPS = 10,000,<br> #steps = 18       |
...
|        | 7x7  | 0.2s         | `[[ 1  2  3  4  5  6  7]` <br> `[ 8  9 10 11 12 13 14]` <br> `[15 16 18 25 26 19 21]` <br> `[23 29 17 39 33 20 28]` <br> `[ 0 30 31 24 32 27 34]` <br> `[22 45 44 38 40 41 35]` <br> `[37 36 43 46 47 48 42]]` | `[[ 1  2  3  4  5  6  7]` <br> `[ 8  9 10 11 12 13 14]` <br> `[15 16 17 18 19 20 21]` <br> `[22 23 24 25 26 27 28]` <br> `[29 30 31 32 33 34 35]` <br> `[36 37 38 39 40 41 42]` <br> `[43 44 45 46 47 48  0]]` | RANDOMIZED_STEPS = 100, <br>#steps = 36          |
| DFS    | 2x2  | 0.01s        | `[[3 1]` <br> `[2 0]]`                                                                                        | `[[1 2]` <br> `[3 0]]`                                                                                        | RANDOMIZED_STEPS = 10,000, <br>Depth: 4, <br>#steps = 4  |
|        | 3x3  | 0.01s        | `[[4 1 6]` <br> `[3 0 5]` <br> `[2 7 8]]`                                                                     | `[[1 2 3]` <br> `[4 5 6]` <br> `[7 8 0]]`                                                                     | RANDOMIZED_STEPS = 10,000, <br>Depth: 20,<br>#steps = 20 |
|        | 4x4  | 4.1s         | `[[13 14 7 6]` <br> `[3 0 1 8]` <br> `[2 12 9 15]` <br> `[11 10 4 5]]`                                         | -                                                                                                              | RANDOMIZED_STEPS = 10,000, <br> No solution found (Depth limit: 20) |
|        | 5x5  | 1m 13.5s     | `[[7 3 4 5 10]` <br> `[2 0 1 8 9]` <br> `[6 12 13 19 14]` <br> `[11 16 18 24 15]` <br> `[21 17 22 23 20]]`       | `[[1 2 3 4 5]` <br> `[6 7 8 9 10]` <br> `[11 12 13 14 15]` <br> `[16 17 18 19 20]` <br> `[21 22 23 24 0]]`       | RANDOMIZED_STEPS = 100, <br> Depth: 24,<br>#steps = 24  |
|        | 6x6  | 11m 37.7s    | `[[1 15  2 10 11  6]` <br> `[3  0  4  5  9 12]` <br> `[7  8 14 16 17 18]` <br> `[13 20 21 28 22 24]` <br> `[19 26 33 27 23 30]` <br> `[25 31 32 34 29 35]]` | -                                                                                                              | RANDOMIZED_STEPS = 100, <br>No solution found (Depth limit: 25)|
|        | 7x7  | 31m 47.3s    | `[[ 1  2  3  4  5  6  7]` <br> `[ 8  9 10 11 12 13 14]` <br> `[15 16 18 25 26 19 21]` <br> `[23 29 17 39 33 20 28]` <br> `[ 0 30 31 24 32 27 34]` <br> `[22 45 44 38 40 41 35]` <br> `[37 36 43 46 47 48 42]]` | -                                                                                                              | RANDOMIZED_STEPS = 100, <br>No solution found (Depth limit: 25) |
